...
const UpdateLessonForm = ({
  ...
  async function onSubmit(
    data: z.infer<typeof ADD_LESSON_SCHEMA_WITH_OPTIONAL_FIELDS>,
  ) {
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            fields and provide accurate information. You can also upload a
            thumbnail image and video for the lesson.
          </CardDescription>
        </CardHeader>
        <CardContent>
